...
import stormTP.operator.ExitBolt2;
...
public class TopologyT2 {
	...
	public static void main(String[] args) throws Exception {
        ...
        /*Tortoise*/
        builder.setBolt("tortoise", new MyTortoiseBolt(), nbExecutors).shuffleGrouping("masterStream");
        /*Affectation à la topologie du bolt qui émet le flux de sortie, il prendra en input le bolt nofilter*/
        builder.setBolt("exit", new ExitBolt2(portOUTPUT), nbExecutors).shuffleGrouping("tortoise");
